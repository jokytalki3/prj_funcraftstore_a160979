Public Class frm_orders
    ...
    Private Sub frm_orders_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim mysql As String = "SELECT * FROM TBL_ORDERS_A160979"
