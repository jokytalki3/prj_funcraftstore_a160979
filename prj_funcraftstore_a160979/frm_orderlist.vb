Public Class frm_orderlist

    Private Sub grd_orderlist_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grd_orderlist.CellContentClick

    End Sub

    Private Sub frm_orderlist_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim mysql As String = "SELECT * FROM TBL_ORDER_DETAILS_A160979"
